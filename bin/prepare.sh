...
MINIO_SECRETS_PATH="./Secrets/Minio"
MINIO_ACCESS_KEY_SECRET="${MINIO_SECRETS_PATH}/MINIO_ACCESS_KEY"
MINIO_SECRET_KEY_SECRET="${MINIO_SECRETS_PATH}/MINIO_SECRET_KEY"
...
mkdir -p ${MINIO_SECRETS_PATH}

MINIO_ACCESS_KEY="$(createPassword)"
MINIO_SECRET_KEY="$(createPassword)"

echo "${MINIO_ACCESS_KEY}" > ${MINIO_ACCESS_KEY_SECRET}
echo "${MINIO_SECRET_KEY}" > ${MINIO_SECRET_KEY_SECRET}
